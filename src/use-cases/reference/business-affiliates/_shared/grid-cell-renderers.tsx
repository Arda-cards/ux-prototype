/**
 * Grid cell renderers for the Suppliers list view.
 *
 * Copied from @/components/extras/molecules/data-grid/presets/common/common-cell-renderers.tsx
 * Only SelectAllHeaderComponent and SelectionCheckboxCell are needed.
 * Dependencies: ag-grid-community types, React — no other extras imports.
 */
