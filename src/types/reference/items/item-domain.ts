...
export interface Supply {
  ...
  unitCost?: import('@/types/model').Money;
  averageLeadTime?: import('@/types/model').Duration;
  orderNotes?: string;
  orderCost: import('@/types/model').Money;
}
...
export interface ItemStatus {
  ...
  toOrder?: Quantity;
  cardsInCart?: number;
  totalCost?: import('@/types/model').Money;
  maxLeadTime?: import('@/types/model').Duration;
  queueAge?: import('@/types/model').Duration;
  labeled?: boolean;
}
...
export interface Item {
  ...
  useCase?: string;
  locator?: import('@/types/model').Locator;
  internalSKU?: string;
