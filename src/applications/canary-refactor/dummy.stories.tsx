    ...
    <div className="flex flex-col gap-6 p-8">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-sm text-amber-600">
          This section mirrors the Dev Witness pages, progressively replacing vendored
          production components with canary-stage library components. Each page here validates
          that canary components can replace their production counterparts without visual or
      ...
      <div className="rounded-lg border border-dashed border-amber-400 bg-amber-50 p-6">
        ...
        <p className="mb-4 text-sm text-amber-600">
          No pages have been refactored yet. As canary components are built, corresponding
          pages will appear here alongside their Dev Witness originals for comparison.
        </p>
