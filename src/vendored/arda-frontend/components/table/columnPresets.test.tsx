...
describe('itemsColumnDefs cell renderers', () => {
  ...
  it('cardSize renderer renders label text (vertical centering via cellStyle on column def)', () => {
    const cr = getCellRenderer('cardSize');
    const { container } = render(cr(makeMockParams({ cardSize: 'MEDIUM' })));
  ...
  it('labelSize renderer renders label text (vertical centering via cellStyle on column def)', () => {
    const cr = getCellRenderer('labelSize');
    const { container } = render(cr(makeMockParams({ labelSize: 'SMALL' })));
    expect(container.firstElementChild?.tagName.toLowerCase()).toBe('span');
    expect(container.firstElementChild).toBeInTheDocument();
  ...
  it('breadcrumbSize renderer renders label text (vertical centering via cellStyle on column def)', () => {
    const cr = getCellRenderer('breadcrumbSize');
    const { container } = render(cr(makeMockParams({ breadcrumbSize: 'LARGE' })));
    expect(container.firstElementChild?.tagName.toLowerCase()).toBe('span');
    expect(container.firstElementChild).toBeInTheDocument();
