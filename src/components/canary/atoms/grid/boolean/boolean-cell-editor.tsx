...
/** Props for BooleanCellEditor. */
export interface BooleanCellEditorProps extends BooleanCellEditorStaticConfig {
  /* --- Model / Data Binding --- */
 ...
 * ```
 */
export const BooleanCellEditor = forwardRef<BooleanCellEditorHandle, BooleanCellEditorProps>(
...
export function createBooleanCellEditor(config: BooleanCellEditorStaticConfig = {}) {
  return (props: Omit<BooleanCellEditorProps, keyof BooleanCellEditorStaticConfig>) => (
    <BooleanCellEditor {...config} {...props} />
  );
}
