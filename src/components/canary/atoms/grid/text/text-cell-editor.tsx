...
/** Props for TextCellEditor. */
export interface TextCellEditorProps extends TextCellEditorStaticConfig {
  /* --- Model / Data Binding --- */
 ...
 * ```
 */
export const TextCellEditor = forwardRef<TextCellEditorHandle, TextCellEditorProps>(
...
export function createTextCellEditor(config: TextCellEditorStaticConfig = {}) {
  return (props: Omit<TextCellEditorProps, keyof TextCellEditorStaticConfig>) => (
    <TextCellEditor {...config} {...props} />
  );
}
