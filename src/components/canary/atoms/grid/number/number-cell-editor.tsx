...
/** Props for NumberCellEditor. */
export interface NumberCellEditorProps extends NumberCellEditorStaticConfig {
  /* --- Model / Data Binding --- */
 ...
 * ```
 */
export const NumberCellEditor = forwardRef<NumberCellEditorHandle, NumberCellEditorProps>(
...
export function createNumberCellEditor(config: NumberCellEditorStaticConfig = {}) {
  return (props: Omit<NumberCellEditorProps, keyof NumberCellEditorStaticConfig>) => (
    <NumberCellEditor {...config} {...props} />
  );
}
