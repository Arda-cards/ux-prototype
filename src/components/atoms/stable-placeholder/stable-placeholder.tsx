...
export function StableAtomPlaceholder({
  ...
  return (
    <div
      className={`inline-flex items-center gap-2 rounded-md border border-dashed border-blue-400 bg-blue-50 px-3 py-1.5 text-sm font-medium text-blue-700 ${className ?? ''}`.trim()}
      {...props}
    >
