...
/**
 * Inline image URL editor adapted for the createInteractive pattern.
 * Unlike the AG Grid cell editor, this uses onChange/onComplete/onCancel callbacks.
 */
function ImageCellInlineEditor({
  value,
  onChange,
  onComplete,
  onCancel,
...
/**
 * Interactive image cell: displays image thumbnail by default, switches to inline editor
 * on double-click, commits on blur/Enter, cancels on Escape.
 */
export const ArdaImageCellInteractive = createInteractive<string>({
  DisplayComponent: ArdaImageCellDisplay,
  EditorComponent: ImageCellInlineEditor,
  displayName: 'ArdaImageCellInteractive',
});
