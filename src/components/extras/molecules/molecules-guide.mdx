...
<Meta title="Components/Stable/Molecules/Overview" />
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><code>Components/Stable/Molecules/</code></td>
...
3. **Create stories** with the title `Components/Stable/Molecules/{ComponentName}`.
