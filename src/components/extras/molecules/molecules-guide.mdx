...
<Meta title="Components/Extras/Molecules/Overview" />
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><code>Components/Extras/Molecules/</code></td>
...
3. **Create stories** with the title `Components/Extras/Molecules/{ComponentName}`.
