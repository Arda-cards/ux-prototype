...
> **Migration note:** This component was previously named `ArdaConfirmDialog`. The old name is still exported as a deprecated alias.
...
- **ArdaItemDrawer** &#8212; Uses ConfirmDialog for the cancel-with-confirmation flow in edit mode
