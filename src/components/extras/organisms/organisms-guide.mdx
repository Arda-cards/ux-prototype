...
<Meta title="Components/Extras/Organisms/Overview" />
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><code>Components/Extras/Organisms/Shared/</code></td>
    ...
    <tr>
      ...
      <td><code>Components/Extras/Organisms/Reference/&#123;Domain&#125;/</code></td>
...
3. Set the story title to `Components/Extras/Organisms/Reference/{Domain}/{Component Name}`.
...
3. Story titles follow `Components/Extras/Organisms/Reference/{Domain Name}/{Component Name}`.
...
2. Set the story title to `Components/Extras/Organisms/Shared/{Component Name}`.
...
```
Components/Extras/Organisms/Shared/{Component Name}
Components/Extras/Organisms/Reference/Items/{Component Name}
Components/Extras/Organisms/Reference/Business Affiliates/{Component Name}
```
