...
<Meta title="Components/Stable/Organisms/Overview" />
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><code>Components/Stable/Organisms/Shared/</code></td>
    ...
    <tr>
      ...
      <td><code>Components/Stable/Organisms/Reference/&#123;Domain&#125;/</code></td>
...
3. Set the story title to `Components/Stable/Organisms/Reference/{Domain}/{Component Name}`.
...
3. Story titles follow `Components/Stable/Organisms/Reference/{Domain Name}/{Component Name}`.
...
2. Set the story title to `Components/Stable/Organisms/Shared/{Component Name}`.
...
```
Components/Stable/Organisms/Shared/{Component Name}
Components/Stable/Organisms/Reference/Items/{Component Name}
Components/Stable/Organisms/Reference/Business Affiliates/{Component Name}
```
