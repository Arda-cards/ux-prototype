...
2. If changes are detected, an ConfirmDialog appears asking to discard changes.
...
- **ConfirmDialog** &#8212; Atom used for the cancel-with-confirmation flow when discarding unsaved form changes.
