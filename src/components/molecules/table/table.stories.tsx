...
const inventoryData = [
  { id: 1, name: 'Hex Socket Bolt M8x40', sku: 'FST-HSB-M8X40', category: 'Fasteners', qty: 342, status: 'In Stock' },
  { id: 2, name: 'Safety Goggles Pro', sku: 'SFI-SGP-001', category: 'PPE', qty: 8, status: 'Low Stock' },
  { id: 3, name: 'Hydraulic Filter HF-200', sku: 'HTS-HF200-R', category: 'Filters', qty: 0, status: 'Out of Stock' },
  { id: 4, name: 'Bearing SKF 6205', sku: 'SKF-6205-2RS', category: 'Bearings', qty: 156, status: 'In Stock' },
  { id: 5, name: 'V-Belt A68', sku: 'GTS-VBA68', category: 'Drive', qty: 4, status: 'Low Stock' },
  { id: 6, name: 'Lubricant Grease EP2', sku: 'SHL-GEP2-400', category: 'Lubricants', qty: 45, status: 'In Stock' },
];
