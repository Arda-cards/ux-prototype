...
<Meta title="Docs/Components/Classification" />
...
> **Note:** Components in `extras/` directories are **off-maturity-track** &#8212; they serve as examples or reference implementations only and are not actively maintained toward promotion. Only Nominal and Canary components participate in the maturity promotion track.
