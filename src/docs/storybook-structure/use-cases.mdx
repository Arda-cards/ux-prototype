...
<Meta title="Docs/Storybook Structure/Use Cases" />
...
> For a condensed step-by-step recipe and migration guide, see the [Use Case Framework Workflow Guide](?path=/docs/docs-workflows-use-case-framework--docs).
