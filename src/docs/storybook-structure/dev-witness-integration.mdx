...
The `withFullAppProviders` decorator in `src/decorators/withFullAppProviders.tsx` wraps every story whose title starts with `Dev Witness`. It composes the same provider hierarchy used in the production application:
...
The Dev Witness section contains 10 page stories with 14 total variants:
...
<table>
  ...
  <tbody>
    <tr>
      <td>Dev Witness/Sign In</td>
      <td><code>/signin</code></td>
      <td>Default, InvalidCredentials</td>
    </tr>
    <tr>
      <td>Dev Witness/Dashboard</td>
      <td><code>/dashboard</code></td>
      <td>Default</td>
    </tr>
    <tr>
      <td>Dev Witness/Items Grid</td>
      <td><code>/items</code></td>
      <td>Default, EmptyState</td>
    </tr>
    <tr>
      <td>Dev Witness/Item Detail</td>
      <td><code>/item/[itemId]</code></td>
      <td>Default</td>
    </tr>
    <tr>
      <td>Dev Witness/Kanban Card</td>
      <td><code>/kanban/cards/[cardId]</code></td>
      <td>Default</td>
    </tr>
    <tr>
      <td>Dev Witness/Order Queue</td>
      <td><code>/order-queue</code></td>
      <td>Default, EmptyQueue</td>
    </tr>
    <tr>
      <td>Dev Witness/Receiving</td>
      <td><code>/receiving</code></td>
      <td>Default</td>
    </tr>
    <tr>
      <td>Dev Witness/Scan</td>
      <td><code>/scan</code></td>
      <td>Default</td>
    </tr>
    <tr>
      <td>Dev Witness/Company Settings</td>
      <td><code>/company-settings</code></td>
      <td>Default</td>
    </tr>
    <tr>
      <td>Dev Witness/Account Profile</td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Playwright</td>
      <td>Pixel-level comparison of 10 Dev Witness page screenshots against baselines (1% diff threshold)</td>
    </tr>
    <tr>
...
2. A **Dev Witness (Migrated)** story section will provide side-by-side comparison with the original vendored pages.
