...
<Meta title="Docs/Misc/Applications" />
...
Mocks live in `src/dev-witness/` and are organized by application area (e.g., dashboard, settings, onboarding).

## How to Add a Page

1. **Create a directory** under `src/dev-witness/`:

```
src/dev-witness/my-page/
  MyPage.tsx
  MyPage.stories.tsx
```
