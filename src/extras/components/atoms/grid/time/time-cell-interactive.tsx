...
export interface ArdaTimeCellInteractiveProps extends AtomProps<string>, TimeCellStaticConfig {}

export function ArdaTimeCellInteractive({
  value,
  onChange,
  onComplete,
  onCancel,
