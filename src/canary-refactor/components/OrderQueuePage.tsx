...
/**
 * Canary-refactor fork of app/order-queue/page.tsx
 *
 * Currently identical to the vendored original.
 * Future commits will swap vendored components with canary equivalents.
 *
